...
class Stock{
  ...
  function stock_news(){
     $events = array(
      ...
      array("story"=> "CEO featured on cover of Super Cool CEOs Magazine", "gain"=> 3),
      ...
      array("story"=> "employees unionize", "gain"=> -4),
      ...
      array("story"=> "stock downgraded", "gain"=> -8),
      ...
      array("story"=> "crappy new product announced", "gain"=> -21),
      ...
      array("story"=> "CEO has email hacked", "gain"=> random_int(-10, -5)),
      array("story"=> "CEO goes on ENN news show", "gain"=> random_int(5, 10)),
      array("story"=> "customer support wins award", "gain"=> random_int(10, 15)),
      array("story"=> "product added to list of super hot x-mas buys", "gain"=> random_int(10, 15)),
