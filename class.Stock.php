...
class Stock{
  ...
  function stock_news(){
     $events = array(
      ...
      array("story"=> "stock buy back announced", "gain"=> rand(1, 7)),
      ...
      array("story"=> "stock upgraded", "gain"=> rand(2, 6)),
      ...
      array("story"=> "company janitor created new patent pending design", "gain"=> rand(1, 19)),
      ...
      array("story"=> "18-25 year old customers have abandoned the company", "gain"=> -13),
      array("story"=> "product recall after customer's pants catch on fire", "gain"=> -18),
      array("story"=> "CEO sells all her stocks", "gain"=> -60),
      array("story"=> "Hipsters discover product", "gain"=> rand(20, 45)),
      array("story"=> "Hipsters abandon product", "gain"=> rand(-20, -50)),
      array("story"=> "FBI raids headquarters", "gain"=> -42)
    );
    if(rand(0, 100) <= 6){
      shuffle($events);
  ...
  function random_name($name_word_length=2){
    $word_list = Array(
     'above','accident','act','activist','actor','add','administration','adviser','against','age','agency','aggression','agriculture','aid','aim','air','airplanes','airport','all','ally','almost','always','ambassador','amend','ammunition','among','amount','anarchy','ancient','anger','animal','anniversary','announce','another','answer','ape','apologize','appeal','appear','appoint','approved','area','argue','arms','army','around','arrest','arrive','art','artillery','ash','ask','assist','astronaut','asylum','atmosphere','atom','attack','attempt','attend','automobile','autumn','awake','award','away',
         'back','bad','balance','ball','balloon','ballot','bank','bar','base','battle','beach','beat','beauty','because','become','bed','beg','begin','bells','below','best','betray','better','big','bill','bird','bite','bitter','black','blame','blanket','bleed','blind','block','blood','blow','blue','boat','body','boil','bomb','bone','book','border','born','borrow','both','bottle','bottom','box','boy','brain','brave','bread','break','breathe','bridge','brief','bright','broadcast','brother','brown','build','bullet','burn','burst','bus','business',
         ...
         'sabotage','sacrifice','safe','sail','salt','same','satellite','satisfy','save','say','school','science','scream','sea','search','season','seat','second','secret','security','see','seek','seem','seize','self','sense','sentence','separate','series','serious','sermon','settle','several','severe','shake','shape','share','sharp','shell','shine','ship','shock','shoe','shoot','short','shout','show','shrink','shut','sick','side','sign','signal','silence','silver','similar','simple','since','sing','sink','situation','skeleton','skill','skull','sky','slave','sleep','slide','slow','small','smash','smile','smoke','smooth','snow','social','soft','soldier','solid','solve','some','soon','sorry','sound','south','space','speak','special','speed','spend','spill','spilt','spirit','split','sports','spread','spring','spy','stab','stamp','stand','star','start','starve','state','station','statue','steal','steam','steel','step','stick','stomach','stone','stop','store','storm','story','stove','straight','strange','street','stretch','strike','strong','struggle','stubborn','study','stupid','submarine','substance','substitute','subversion','succeed','such','sudden','suffer','sugar','summer','sun','supervise','supply','support','suppose','suppress','sure','surplus','surprise','surrender','surround','survive','suspect','suspend','swallow','swear','sweet','swim','sympathy','system',
         'take','talk','tall','tank','target','task','taste','tax','teach','team','tear','tears','technical','telephone','telescope','television','tell','temperature','temporary','term','terrible','territory','terror','test','textiles','thank','that','theater','thick','thin','thing','think','third','threaten','through','throw','tie','time','tired','tissue','today','together','tomorrow','tonight','tool','top','torture','touch','toward','town','trade','tradition','tragic','train','traitor','transport','trap','travel','treason','treasure','treat','treaty','tree','trial','tribe','trick','trip','troops','trouble','truck','trust','turn',
         ...
         'wages','wait','walk','wall','want','warm','warn','wash','waste','water','wave','way','weak','wealth','weapon','wear','weather','weigh','welcome','well','west','wet','wheat','wheel','white','wide','wild','wind','window','wire','wise','wish','withdraw','without','woman','wonder','wood','woods','word','work','world','worry','worse','wound','wreck','write','wrong',
